...
class PTB_List_Table_CPT extends WP_List_Table {
    ...
    function column_singular_label($item) {
        ...
        $actions = array(
            'edit' => sprintf(
                    '<a href="?page=%1$s&action=%2$s&post_type=%3$s" data-slug="%3$s" class="ptb_cpt_edit">%4$s</a>', $_REQUEST['page'], 'edit', $item['ID'], __('Edit', 'ptb')
            ),
            'copy' => sprintf(
                    '<a href="?page=%1$s&action=%2$s&post_type=%3$s" data-slug="%3$s" class="ptb_cpt_copy">%4$s</a>', $_REQUEST['page'], 'copy', $item['ID'], __('Duplicate', 'ptb')
            ),
            'delete' => sprintf(
                    '<a href="?page=%1$s&action=%2$s&post_type=%3$s" data-slug="%4$s" class="ptb_cpt_delete">%5$s</a>', $_REQUEST['page'], 'delete', $item['singular_label'], $item['ID'], __('Delete', 'ptb')
            )
        );
