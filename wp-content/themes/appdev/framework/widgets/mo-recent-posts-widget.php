...
class MO_Recent_Posts_Widget extends MO_Widget {
    ...
    function MO_Recent_Posts_Widget() {
        ...
        /* Widget settings. */
        $widget_ops = array('classname' => 'recent-posts-widget', 'description' => __('A widget that displays the recent posts with thumbnails.', 'mo_theme'));

        /* Widget control settings. */
        $control_ops = array('width' => 300, 'height' => 350, 'id_base' => 'mo-recent-posts-widget');

        /* Create the widget. */
        $this->WP_Widget('mo-recent-posts-widget', __('Recent Posts Widget', 'mo_theme'), $widget_ops, $control_ops);
    }
    ...
    function form($instance) {
        ...
        $defaults = array('title' => __('Recent Posts', 'mo_theme'), 'post_count' => '5', 'excerpt_count' => '100', 'hide_thumbnail' => false, 'show_meta' => false);
